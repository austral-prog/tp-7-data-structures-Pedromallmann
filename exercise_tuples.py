...
def convert_coordinate(coordenada):
    ...
    """
    return (coordenada [0:-1], coordenada [-1])
print(convert_coordinate(('10A')))
...
def create_record(registro_azara, registro_rui):
    ...
    """
    azara_conv = convert_coordinate(registro_azara[1])
    if azara_conv != registro_rui[1]:
        return "not a match"
    else:
